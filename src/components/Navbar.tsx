...
import { Utensils, LayoutDashboard, ArrowDownCircle, ArrowUpCircle, FileText } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <h1 className="text-xl font-bold text-blue-600 flex items-center gap-2">
            <Utensils size={24} /> <span className="hidden sm:inline">Kedai Elvera 57</span>
          </h1>
          ...
          <div className="flex items-center gap-1 sm:gap-4">
            ...
            <button 
              ...
              className={`px-3 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'pemasukan' ? 'bg-blue-600 text-white' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              <ArrowUpCircle size={18} /> <span className="hidden md:inline">Pemasukan</span>
            </button>
            <button 
